...
const struct default_syscall_info syscalls[MAX_SYSCALL_NR] = {
    ...
    [172] = {"iopl", 1},
    [173] = {"ioperm", 3},
    [174] = {"create_module", 0}, // Deprecated
    [175] = {"init_module", 3},
    [176] = {"delete_module", 2},
    [177] = {"get_kernel_syms", 0}, // Deprecated
    [178] = {"query_module", 0},    // Deprecated
    [179] = {"quotactl", 4},
    [180] = {"nfsservctl", 0},      // Deprecated
    [181] = {"getpmsg", 0},         // Obsolete
    [182] = {"putpmsg", 0},         // Obsolete
    [183] = {"afs_syscall", 0},     // Reserved
    [184] = {"tuxcall", 0},         // Reserved
    [185] = {"security", 0},        // Reserved
    [186] = {"gettid", 0},
    [187] = {"readahead", 3},
    [188] = {"setxattr", 5},
    [189] = {"lsetxattr", 5},
    ...
    [213] = {"epoll_create", 1},
    [214] = {"epoll_ctl_old", 0},   // Deprecated
    [215] = {"epoll_wait_old", 0}, // Deprecated
    ...
    [442] = {"mount_setattr", 5},
    [443] = {"quotactl_fd", 3},
    [444] = {"landlock_create_ruleset", 2},
    [445] = {"landlock_add_rule", 3},
